...
try {
    ...
    $columns = '';
    $columns = $dba->SELECT('t_items', DBA::ALL, DBA::NUMVALUE, 'item_id = ?', [32]);
        ...
        <div class="container-fluid my-5">
            ...
            <div class="container-fluid my-4">
                ...
                <div class="row justify-content-center">
                    ...
                    <img class="col-8 my-3" src="./img/GODEATER.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        打撃と射撃を即座に切り替えて繰り出すハイスピードなアクションと、<br>
                        個性的なキャラクター達との壮大なストーリーが魅力の<br>
                        「ゴッドイーター」シリーズ最新作が、 新たな神機やアラガミ、進化したアクションを携えついに登場する！
                    </p>
                    ...
                    <img class="col-8 my-3" src="./img/GODEATER3.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        新たな近接武器パーツとして、二刀流の神機「バイティングエッジ」、<br>
                        斧へと変形する円月状の両手持ち神機「ヘヴィムーン」が追加！<br>
                        銃身パーツでは新たに「レイガン」が登場し、バトルスタイルの幅が更に広がる！
                    </p>
                    ...
                    <img class="col-8 my-3" src="./img/GODEATER2.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        地上・空中・ステップの各アクションがバースト中に必殺技へ進化する<br>
                        「バーストアーツ」と、新たな移動攻撃「ダイブ」を駆使して、<br>
                        縦横無尽にフィールドを駆け回りアラガミを翻弄せよ！
                    </p>
                </div>
            </div>
    </main>
