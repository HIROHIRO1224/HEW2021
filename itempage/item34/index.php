...
try {
    ...
    $columns = '';
    $columns = $dba->SELECT('t_items', DBA::ALL, DBA::NUMVALUE, 'item_id = ?', [34]);
        ...
        <div class="container-fluid my-5">
            ...
            <div class="container-fluid my-4">
                ...
                <div class="row justify-content-center">
                    ...
                    <img class="col-8 my-3" src="./img/Street2.jpg" alt="">
                    ...
                    <img class="col-8 my-3" src="./img/Street3.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        「ストリートファイターV：チャンピオンエディション」は、シーズン4までに
                        配信された2000を超えるDLCを一つにまとめたパッケージです。<br>
                        プレイアブルの40キャラクター、34ものステージ、200を超えるコスチュームでのプレイが可能！
                    </p>
                </div>
            </div>
    </main>
