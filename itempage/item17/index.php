...
try {
    ...
    $columns = '';
    $columns = $dba->SELECT('t_items', DBA::ALL, DBA::NUMVALUE, 'item_id = ?', [17]);
...
<head>
    ...
    <!-- ここに商品名 -->
    <title>Splatoon 2 (スプラトゥーン2)</title>
        ...
        <div class="container-fluid my-5">
            ...
            <div class="container-fluid my-4">
                ...
                <div class="row justify-content-center">
                    ...
                    <img class="col-8 my-3" src="./img/supura1.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        イカとヒト、ふたつの姿を使いこなせ！<br>
                    ...
                    <img class="col-8 my-3" src="./img/supura2.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                    ...
                    <img class="col-8 my-3" src="./img/supura3.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
