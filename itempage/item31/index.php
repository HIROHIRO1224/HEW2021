...
try {
    ...
    $columns = '';
    $columns = $dba->SELECT('t_items', DBA::ALL, DBA::NUMVALUE, 'item_id = ?', [31]);
        ...
        <div class="container-fluid my-5">
            ...
            <div class="container-fluid my-4">
                ...
                <div class="row justify-content-center">
                    ...
                    <img class="col-8 my-3" src="./img/ELDEN1.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        刺激に満ちた広大な世界刺激に満ちた広大な世界<br>
                        多彩なシチュエーションを持つオープンなフィールドと、<br>
                        複雑かつ立体的に作り込まれた巨大ダンジョンが<br>

                        シームレスに繋がる広大な世界。<br>
                        探索の先には、未知の発見による喜びと高い達成感へと繋がる<br>
                        圧倒的な脅威がプレイヤーを待ち受けます。<br>

                        自由度の高い探索自由度の高い探索<br>
                        機動力に長け、険しい崖も駆けおりる霊馬や、<br>
                        攻略の幅を広げるジャンプアクションを採用。<br>


                        広大なフィールドや複雑なダンジョンの探索を、<br>
                        自由かつ快適に楽しめます。
                    </p>
                    ...
                    <img class="col-8 my-3" src="./img/ELDEN2.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        プレイヤーキャラクターは外見のカスタマイズに加え、<br>
                        身につける武器や防具、魔法を自由に組み合わせることが可能。<br>
                        筋力を高めて屈強な戦士となる、あるいは、魔術を極めるなど<br>
                        自分のプレイスタイルに合わせてキャラクターを<br>
                        成長させることができます。
                    </p>
                    ...
                    <img class="col-8 my-3" src="./img/ELDEN3.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        剣戟による近接戦闘だけでなく、魔法や弓といった遠距離攻撃闇に潜み敵を討つステルスや霊体を召喚しての共闘など、<br>
                        脅威を乗り越えるための豊富な戦略が用意されています。
                    </p>


                    <h3 class="col-9 mt-5 font-weight-bold mb-3">
                        神話から生まれる神話から生まれる群像劇群像劇
                    </h3>
                    <img class="col-8 my-3" src="./img/ELDEN4.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        断片的に語られる、重層的な物語。。<br>
