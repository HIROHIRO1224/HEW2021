...
try {
    ...
    $columns = '';
    $columns = $dba->SELECT('t_items', DBA::ALL, DBA::NUMVALUE, 'item_id = ?', [33]);
        ...
        <div class="container-fluid my-5">
            ...
            <div class="container-fluid my-4">
                ...
                <div class="row justify-content-center">
                    ...
                    <img class="col-8 my-3" src="./img/Nie.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        舞台は、宇宙人が繰り出す「機械生命体」の圧倒的戦力を前に、<br>
                        人類が月へと敗走している遥か未来。プレイヤーは、新たに<br>
                        組織されたアンドロイド部隊「ヨルハ」所属の「2B」となり、<br>
                        地球奪還のための熾烈な戦いに身を投じます。
                    </p>


                    <h3 class="col-9 mt-5 font-weight-bold mb-3">
                        単なるエンターテインメント作品にとどまらない
                    </h3>
                    <img class="col-8 my-3" src="./img/Nie2.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        さまざまな感情をかき立てる物語を、滑らかな60fpsのオープンワールドで
                        お楽しみいただけます。
                    </p>
                    ...
                    <img class="col-8 my-3" src="./img/Nie3.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        突如侵略してきた異星人。そして彼らが繰り出す兵器「機械生命体」。<br>
                        圧倒的戦力の前に、人類は月へと逃げ延びていた。<br>
                        人類側は地球を奪還する為に、アンドロイド兵士による抵抗軍を組織。<br>
                        更に膠着した状態を打破する為、新型アンドロイドである戦闘用歩兵「ヨルハ」部隊を
                        投入する。人のいない不毛の地で、機械生命体とアンドロイドによる
                        熾烈な戦いが繰り広げられ、それはやがて真実の扉を開けてしまうことになる。
                    </p>
                </div>
            </div>
    </main>
