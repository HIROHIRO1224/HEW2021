...
try {
    ...
    $columns = '';
    $columns = $dba->SELECT('t_items', DBA::ALL, DBA::NUMVALUE, 'item_id = ?', [40]);
            ...
            <div class="container-fluid my-4">
                ...
                <div class="row justify-content-center">
                    ...
                    <h3 class="col-9 mt-5 font-weight-bold mb-3">
                        Fate/EXTRAシリーズ最新作『Fate/EXTELLA LINK』が始動
                    </h3>
                    <img class="col-8 my-3" src="./img/extella1.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        「Fate」シリーズのサーヴァントが作品の枠を越えて参戦。
                        縦横無尽にフィールドを駆け巡り、宝具など華麗な技を駆使しバトルを繰り広げるアクションゲーム。<br>
                        新参戦サーヴァント、進化したグラフィックやシステム、<br>
                        新しいシナリオなど新要素満載。
                    </p>
                    ...
                    <img class="col-8 my-3" src="./img/extella2.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        前作『Fate/EXTELLA』をプレイしていると 今作『Fate/EXTELLA LINK』で使用できるゲーム内特典を入手可能
                    </p>
                    ...
                    <img class="col-8 my-3" src="./img/extella3.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        新サーヴァント『シャルルマーニュ』を中心に新しい物語が動き出す。
                        前作に登場した16騎のサーヴァントに加え、新たに10騎のサーヴァントが参戦
                    </p>


                    <h3 class="col-9 mt-5 font-weight-bold mb-3">
                        華麗に進化したグラフィックで贈るハイスピードサーヴァントアクション！
                    </h3>
                    <img class="col-8 my-3" src="./img/extella4.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        進化したグラフィックはもちろんサーヴァントアクションを中心に操作、システムがさらにパワーアップ。<br>
                        バージョンアップした月の世界でサーヴァントたちの新しい戦いが繰り広げられる。
                    </p>
                </div>
            </div>
    </main>
