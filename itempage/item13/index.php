...
try {
    ...
    $columns = '';
    $columns = $dba->SELECT('t_items', DBA::ALL, DBA::NUMVALUE, 'item_id = ?', [13]);
        ...
        <div class="container-fluid my-5">
            ...
            <div class="container-fluid my-4">
                ...
                <div class="row justify-content-center">
                    ...
                    <img class="col-8 my-3" src="./img/Horizon1.jpg" alt="">
                    ...
                    <img class="col-8 my-3" src="./img/Horizon2.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                    ...
                    <img class="col-8 my-3" src="./img/Horizon3.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
