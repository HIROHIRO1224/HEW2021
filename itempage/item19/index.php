...
try {
    ...
    $columns = '';
    $columns = $dba->SELECT('t_items', DBA::ALL, DBA::NUMVALUE, 'item_id = ?', [19]);
...
<head>
    ...
    <!-- ここに商品名 -->
    <title>ドラゴンクエストビルダーズ2 破壊神シドーとからっぽの島</title>
        ...
        <div class="container-fluid my-5">
            ...
            <div class="container-fluid my-4">
                ...
                <div class="row justify-content-center">
                    ...
                    <img class="col-8 my-3" src="./img/draque1.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        今作は、世界を救う大冒険と砂場遊びのようなモノづくりが同時に楽しめるブロックメイクRPGの最新作だ。ブロックで出来た世界を砕いて素材を手に入れ、武器や道具、建物や施設を作っていこう。<br>
                    ...
                    <img class="col-8 my-3" src="./img/draque2.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                    ...
                    <img class="col-8 my-3" src="./img/draque3.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
