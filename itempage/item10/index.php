...
try {
    ...
    $columns = '';
    $columns = $dba->SELECT('t_items', DBA::ALL, DBA::NUMVALUE, 'item_id = ?', [10]);
        ...
        <div class="container-fluid my-5">
            ...
            <div class="container-fluid my-4">
                ...
                <div class="row justify-content-center">
                    ...
                    <img class="col-8 my-3" src="./img/Micra_title.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        無限に広がる世界を探索して、簡素な小屋から豪華絢爛な城まで、さまざまなものを作ろう。クリエイティブ モードで無限の資源を使って自由に遊ぶのか、サバイバル モードで地中深くを掘り進め、武器や防具を作って危険なモブと戦うのかは、あなた次第。
                    </p>
                    ...
                    <img class="col-8 my-3" src="./img/Micra1.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                    ...
                    <img class="col-8 my-3" src="./img/Micra2.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        モブと戦ったり、拠点を作ったり、探検したり！ すべてはサバイバル モードで生き抜くための日常。
                    </p>
                    ...
                    <img class="col-8 my-3" src="./img/Micra3.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        仲間と一緒に建築や探索を楽しもう！ モバイルデバイス、Switch、Xbox One、Windows 10でプレイしている友達とも、クラフト、探索、サバイバルを楽しめる。
                    </p>
                </div>
            </div>
    </main>
