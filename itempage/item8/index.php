...
try {
    ...
    $columns = '';
    $columns = $dba->SELECT('t_items', DBA::ALL, DBA::NUMVALUE, 'item_id = ?', [8]);
    // 追加部分
        ...
        <div class="container-fluid my-5">
            ...
            <div class="container-fluid my-4">
                ...
                <div class="row justify-content-center">
                    ...
                    <img class="col-8 my-3" src="./img/unnamed.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        ゲームロフトの大人気「アスファルト」シリーズの一作、「アスファルト8」で夢の高性能レーシングカーとオートバイを操り、世界中のプレイヤーと対戦しよう！300台以上の一流公認マシン、アクション満載のレース、75種類以上のコース、オフライン&オンラインゲームプレイ、シングルプレイ&マルチプレイヤーモードなど、アーケードゲームに必要な要素がすべて詰まったレーシングゲームの決定版！
                    </p>


                    <h3 class="col-9 mt-5 font-weight-bold mb-3">
                        ダイナミックなハイスピード空中アクション！
                    </h3>
                    <img class="col-8 my-3" src="./img/asphalt2.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        キッカーを使って車やオートバイで大ジャンプ！重力に逆らう空中でのスタント体験を楽しもう！
                        バレルロールや360度のスピンを爽快にキメてライバルに差をつけろ。 車やバイクで空を切り裂くスタントアクションを行い競争力アップ！シミュレーション力を活かしてゴールまでの最短ルートを探し、トップを狙え！
                        アイコンの位置や操作方法は自分好みにカスタマイズ可能！個性的なプレイスタイルを確立して、他のプレイヤーやシングルプレイモードのAIを相手に激しいレースを繰り広げよう！
                    </p>


                    <h3 class="col-9 mt-5 font-weight-bold mb-3">
                        レースマニアを楽しませるコンテンツが続々登場！
                    </h3>
                    <img class="col-8 my-3" src="./img/asphalt3.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        頻繁にあるアップデートでは新コンテンツが続々追加予定！キャリアモードで腕利きのレーサーやライダーをも唸らせる多彩なシーズンとイベントを満喫しよう！
                        InfectionモードとGate Driftモードでゲームがさらに盛り上がる！豪華報酬が用意された期間限定イベントでは、最新レーシングカーをいち早くゲットできるチャンスを見逃すな！
                    </p>


                    <h3 class="col-9 mt-5 font-weight-bold mb-3">
                        充実のマルチプレイヤー&シングルプレイレース！
                    </h3>
                    <img class="col-8 my-3" src="./img/asphalt4.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        マルチプレイヤーシーズン&リーグで同時対戦レースを楽しもう！期間限定シーズンでライバルと競い合ってポイントをゲットすれば、豪華報酬をアンロックできるぞ！
                    </p>
                </div>
            </div>
    </main>
