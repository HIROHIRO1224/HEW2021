...
try {
    ...
    $columns = '';
    $columns = $dba->SELECT('t_items', DBA::ALL, DBA::NUMVALUE, 'item_id = ?', [36]);
        ...
        <div class="container-fluid my-5">
            ...
            <div class="container-fluid my-4">
                ...
                <div class="row justify-content-center">
                    ...
                    <img class="col-8 my-3" src="./img/TEKKEN.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        ダイナミックで直感的な新バトルシステム「レイジアーツ」「パワークラッシュ」による極限バトルを体感。
                    </p>
                    ...
                    <img class="col-8 my-3" src="./img/TEKKEN2.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        1994年の「鉄拳」から繰り広げられてきた三島家因縁が決着。流れるようにバトルへ
                        繋がるストーリーモードでこれまでの数々の謎が明らかに。
                    </p>
                    ...
                    <img class="col-8 my-3" src="./img/TEKKEN3.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
