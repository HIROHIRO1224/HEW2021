...
try {
    ...
    $columns = '';
    $columns = $dba->SELECT('t_items', DBA::ALL, DBA::NUMVALUE, 'item_id = ?', [16]);
        ...
        <div class="container-fluid my-5">
            ...
            <div class="container-fluid my-4">
                ...
                <div class="row justify-content-center">
                    ...
                    <img class="col-8 my-3" src="./img/cyber1.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        さまざまなサイバーウェアでプレイヤーを強化。 伝説のサイバーパンクとなり、ナイトシティに名を残せ。
                    </p>
                    ...
                    <img class="col-8 my-3" src="./img/cyber2.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        唯一無二のオープンワールド。 摩天楼がひしめく未来の都市を、縦横無尽に駆け回れる。
                    </p>
                    ...
                    <img class="col-8 my-3" src="./img/cyber3.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        不老不死の鍵を握るインプラントを手に入れろ。<br>
                        ただし、でかいヤマにはリスクがつきものだ……。
                    </p>
                </div>
            </div>
    </main>
