...
try {
    ...
    $columns = '';
    $columns = $dba->SELECT('t_items', DBA::ALL, DBA::NUMVALUE, 'item_id = ?', [9]);
        ...
        <div class="container-fluid my-5">
            ...
            <div class="container-fluid my-4">
                ...
                <div class="row justify-content-center">
                    ...
                    <img class="col-8 my-3" src="./img/days1.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        相棒・ブーザーとともに賞金稼ぎの旅へ。<br>
                        各地の「キャンプ」からのミッションをクリアしたり、 感染者｢フリーカー｣ を殲滅することで、「キャンプ」の信頼度が上がり、賞金を獲得できる。<br>
                        信頼レベルを上げれば、武器を購入できたり、バイクのカスタマイズでアップグレードもできるから、どんどん「フリーカー」を倒していける。
                    </p>

                    <h3 class="col-9 mt-5 font-weight-bold mb-3">
                        武器やアイテム探索も
                    </h3>
                    <img class="col-8 my-3" src="./img/days2.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        武器は賞金で購入するほか、野盗から奪取したり拾い集めることも可能。さらに所持しているアイテムを組み合わせて新たな武器を作ることも。<br>
                        武器やアイテムの選択で、プレイヤーそれぞれのサバイバル生活を満喫できる。
                    </p>


                    <h3 class="col-9 mt-5 font-weight-bold mb-3">
                        愛車のバイクをアップグレードして有効活用
                    </h3>
                    <img class="col-8 my-3" src="./img/days3.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        唯一の移動手段であるバイクは、見た目はもちろん、性能を上昇させるなど、さまざまなアップグレードが可能。<br>
                        故障したり、ガソリンがなくなったりすることもあるので、愛車を強化して有効活用することも重要な戦略のひとつに。
                    </p>
                </div>
            </div>
    </main>
