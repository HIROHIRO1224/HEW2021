...
try {
    ...
    $columns = '';
    $columns = $dba->SELECT('t_items', DBA::ALL, DBA::NUMVALUE, 'item_id = ?', [26]);
        ...
        <div class="container-fluid my-5">
            ...
            <div class="container-fluid my-4">
                ...
                <div class="row justify-content-center">
                    ...
                    <img class="col-8 my-3" src="./img/kimetu1.jpg" alt="">
                    ...
                    <img class="col-8 my-3" src="./img/kimetu2.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        炭治郎が鬼殺隊に入隊し様々な鬼に立ち向かうTVアニメ「竈門炭治郎立志編」から、炎柱・煉󠄁獄杏寿郎と共に向かった任務を描いた劇場版「無限列車編」までのエピソードを収録。
                    </p>
                    ...
                    <img class="col-8 my-3" src="./img/kimetu3.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        アニメで描かれた凶悪な鬼たちとの闘いを、迫力あるグラフィックと表現にてお届け！
                    </p>


                    <h3 class="col-9 mt-5 font-weight-bold mb-3">
                        アニメ「鬼滅の刃」のキャラクターたちで対戦を楽しもう！
                    </h3>
                    <img class="col-8 my-3" src="./img/kimetu4.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        竈門炭治郎や竈門禰󠄀豆子をはじめアニメ「鬼滅の刃」で迫力ある戦いを繰り広げたキャラクターたちに加え、公式スピンオフアニメ「中高一貫!キメツ学園物語」からも参戦！<br>
                        そして無償アップデートでは「鬼」の参戦も決定！
                    </p>
                </div>
            </div>
    </main>
