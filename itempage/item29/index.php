...
try {
    ...
    $columns = '';
    $columns = $dba->SELECT('t_items', DBA::ALL, DBA::NUMVALUE, 'item_id = ?', [29]);
        ...
        <div class="container-fluid my-5">
            ...
            <div class="container-fluid my-4">
                ...
                <div class="row justify-content-center">
                    ...
                    <img class="col-8 my-3" src="./img/Among1.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        オンラインで4～10人とプレイ。プレイヤーは宇宙船の出発準備をするクルーとなります。<br>
                        しかし仲間の中に1人または複数のインポスター（ランダムのプレイヤー）が紛れ込んでいることをお忘れなく！<br>
                        そして、インポスターは、クルーの皆殺しをもくろんでいる！
                    </p>
                    ...
                    <img class="col-8 my-3" src="./img/Among2.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        インポスターによるサボタージュを急いで解決<br>
                        管理室マップと監視カメラをチェックして他クルーの状況を把握<br>
                        死体を発見したらすぐさま通報して誰がインポスターか議論<br>
                        緊急会議を開いて怪しい行動をしていた人を報告する<br>
                        インポスターと疑われる人を投票で排出
                    </p>
                    ...
                    <img class="col-8 my-3" src="./img/Among3.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        クルーを殺して近くにいた人に罪を着せる<br>
                        タスクをこなす振りをしてクルーに紛れ込む<br>
                        通気孔を使って船中を素早く動き回る<br>
                        サボタージュを使って混乱を起こしクルーを対立させる<br>
                        ドアを閉めて獲物を閉じ込め、誰にも見られずにキル
                    </p>
                    ...
                    <img class="col-8 my-3" src="./img/Among4.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        クルーの色や帽子をカスタマイズ<br>
                        インポスター追加やタスク増などなど多数のゲームオプション！<br>
                        ホス一覧からオンラインゲームがすぐに見つかる<br>
                        ゲーム内テキストチャット<br>
                        Discordインテグレーション<br>
                        クロスプラットフォームのため、PC、Android、iOS間でプレイできる！
                    </p>
                </div>
            </div>
    </main>
