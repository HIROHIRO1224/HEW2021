        ...
        <div class="container-fluid my-5">
            ...
            <div class="container-fluid my-4">
                ...
                <div class="row justify-content-center">
                    ...
                    <img class="col-8 my-3" src="./img/d5397-4166-0ae3a7a5bc8c223fe779-0.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        『ぷよぷよ!!クエスト』は、なぞって消す<br>
                        かんたん操作で大連鎖が楽しい「パズルRPG」です。<br>
                        クエストに挑戦したり、友達とギルドを組んで<br>
                        一緒に楽しんだりすることができます。<br>
                        さらに、おなじみの「ぷよぷよ」ルールであそべる「とことんぷよぷよ」が遊べます
                    </p>
                    ...
                    <img class="col-8 my-3" src="./img/puyoque2.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        フィールド上のぷよをタッチで消そう。<br>
                        空いたスペースに落ちたぷよが同じ色で４つつながると連鎖が発生！<br>
                        連鎖したぷよと同じ色のキャラクターがこうげきするよ。<br>
                        ぷよぷよの基本ルールはそのままに、
                    ...
                    <img class="col-8 my-3" src="./img/puyoque3.png" alt="">
                    <p class="col-9" style="line-height:2rem">
                        クエストで世界を冒険すると、さまざまなキャラクターとバトルするよ。<br>
                        ぷよを消すと仲間キャラクターが相手チームをこうげき！<br>
                        大連鎖を組んで相手チームをたおそう！<br>
                        相手チームに勝つと、次のバトルにすすめるよ。
                    </p>
                    ...
                    <img class="col-8 my-3" src="./img/puyoque4.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        クエストでたおしたキャラクターカードが、ときどき手に入るよ。<br>
                        好きなキャラクターカードを組み合わせて、あなただけのオリジナル<br>
                        チームをつくろう！使用できるキャラクターカードは
                        クエスト以外にガチャでもゲットできるよ！
                    </p>
                </div>
            </div>
