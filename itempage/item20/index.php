...
try {
    ...
    $columns = '';
    $columns = $dba->SELECT('t_items', DBA::ALL, DBA::NUMVALUE, 'item_id = ?', [20]);
        ...
        <div class="container-fluid my-5">
            ...
            <div class="container-fluid my-4">
                ...
                <div class="row justify-content-center">
                    ...
                    <img class="col-8 my-3" src="./img/db1.jpg" alt="">
                    ...
                    <h3 class="col-9 mt-5 font-weight-bold mb-3">
                        「ドラゴンボールZ」を超追体験 </h3>
                    <img class="col-8 my-3" src="./img/db2.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                    ...
                    <img class="col-8 my-3" src="./img/db3.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                    ...
                    <img class="col-8 my-3" src="./img/db4.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
