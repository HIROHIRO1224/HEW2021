...
try {
    ...
    $columns = '';
    $columns = $dba->SELECT('t_items', DBA::ALL, DBA::NUMVALUE, 'item_id = ?', [39]);
        ...
        <div class="container-fluid my-5">
            ...
            <div class="container-fluid my-4">
                ...
                <div class="row justify-content-center">
                    ...
                    <img class="col-8 my-3" src="./img/dofi1.png" alt="">
                    <p class="col-9" style="line-height:2rem">
                        森に迷い込んだ少女。森には危険なドフィたちがいるので危険がいっぱいだ。<br>
                        歩いていると武器になりそうな魔法の杖を拾ったはいいが、使い方がわからない。<br>
                        少女は無事に家に帰ることができるのか！？
                    </p>
                    ...
                    <img class="col-8 my-3" src="./img/dofi2.png" alt="">
                    <p class="col-9" style="line-height:2rem">
                        ステージには穴やトゲもいっぱいあるので気を付けよう。<br>
                        少女の力では敵を倒すことができないので、倒そうとはせず、うまく頭を踏んだり避けたりしてゴールを目指そう！
                    </p>
                    ...
                    <img class="col-8 my-3" src="./img/dofi2.png" alt="">
                    <p class="col-9" style="line-height:2rem">
                        森にはいたるところにドフィたちが飛び回っている。<br>
                        飛び回るタイミングは予測不能なので気を付けて行動しよう。
                    </p>
                </div>
            </div>
    </main>
