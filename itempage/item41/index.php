...
try {
    ...
    $columns = '';
    $columns = $dba->SELECT('t_items', DBA::ALL, DBA::NUMVALUE, 'item_id = ?', [41]);
            ...
            <div class="container-fluid my-4">
                ...
                <div class="row justify-content-center">
                    ...
                    <h3 class="col-9 mt-5 font-weight-bold mb-3">
                        「グランツーリスモ」シリーズ最新作 『グランツーリスモ７』登場。25年におよぶシリーズの歴史が生み出す最高の体験をお届けします。
                    </h3>
                    <img class="col-8 my-3" src="./img/guran1.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        GTキャンペーンモードやアーケード、ドライビングスクールといったさまざまなゲームモードのコレクションから、競い合うのが好きなレーサーやカジュアルなレーサー、コレクター、チューナー、デザイナー、フォトグラファーなど、自分だけのプレイスタイルや楽しみを見つけることができる。<br>
                        伝説のGTキャンペーンモードが再び収録。車両の購入や売却、チューニング、レースをしながら、最新のクルマやチャレンジをアンロックし、シングルキャンペーンを進めて行こう。他のプレイヤーと競い合うのが好きなプレイヤーは、GTスポーツモードで腕を磨こう。<br>
                        『グランツーリスモ７』のブランド・セントラルや中古車ディーラーでは、420種類以上のクルマを利用可能。クラシックカーや、最先端のスーパーカーなどが比類ないディテールで再現されている。天候が変化する中、「グランツーリスモ」史上に残るクラシックなコースを含む90種類以上のコースレイアウトをドライブしながら、クルマごとに異なるパフォーマンスや感覚を体験しよう。
                    </p>
                    ...
                    <img class="col-8 my-3" src="./img/guran2.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        ドライビング体験を助ける新しいツールを活用し、リアルドライビングシミュレーターの全てを楽しもう。
                    </p>
                    ...
                    <img class="col-8 my-3" src="./img/guran3.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        クルマを買って、レースに挑戦して、コレクションして。愛車のカスタマイズもお手のもの。キミだけのカーライフを満喫しよう。
                    </p>
                </div>
            </div>
    </main>
