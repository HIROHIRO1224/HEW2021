...
try {
    ...
    $columns = '';
    $columns = $dba->SELECT('t_items', DBA::ALL, DBA::NUMVALUE, 'item_id = ?', [30]);
        ...
        <div class="container-fluid my-5">
            ...
            <div class="container-fluid my-4">
                ...
                <div class="row justify-content-center">
                    ...
                    <img class="col-8 my-3" src="./img/DARK1.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        古い時代<br>
                        世界はまだ分かたれず、霧に覆われ<br>
                        灰色の岩と大樹、朽ちぬ古竜ばかりがあった<br>
                        ...
                        最初の死者、ニト<br>
                        イザリスの魔女と、混沌の娘たち<br>
                        太陽の光の王グウィンと、彼の騎士たち<br>
                        そして、誰も知らぬ影の小人<br>

                        それは王の力を得、古竜に戦いを挑んだ<br>


                        グウィンの雷が、岩のうろこを貫き<br>
                        魔女の火炎は嵐となり<br>
                        死の瘴気がニトによって解き放たれた<br>
                        <br>
                        そしてうろこのない白竜、シースの裏切りにより、<br>
                        遂に古竜は敗れた<br>
                        ...
                        今や、火はまさに消えかけ、人の世には届かず、夜ばかりが続き<br>
                    ...
                    <img class="col-8 my-3" src="./img/DARK2.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        絶望と希望のダークファンタジー<br>
                        荒廃した世界を舞台に、探索の緊張感、敵と遭遇したときの恐怖、新しい発見による喜びなど、RPGが本来持っている根本的な面白さと、<br>
                        高い達成感につながるゲームデザインを追求したアクションRPG『DARK SOULS』。
                    </p>
                </div>
            </div>
    </main>
