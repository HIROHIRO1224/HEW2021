...
try {
    ...
    $columns = '';
    $columns = $dba->SELECT('t_items', DBA::ALL, DBA::NUMVALUE, 'item_id = ?', [15]);
...
<head>
    ...
    <!-- ここに商品名 -->
    <title>Star Wars ジェダイ:フォールン・オーダー</title>
            ...
            <div class="container-fluid my-4">
                ...
                <div class="row justify-content-center">
                    ...
                    <h3 class="col-9 mt-5 font-weight-bold mb-3">
                        Respawn Entertainmentが贈る3人称視点アクション・アドベンチャー最新作、2019年11月15日発売
                    </h3>
                    <img class="col-8 my-3" src="./img/jedi1.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        Respawn Entertainmentが手掛ける新たな3人称視点アクション・アドベンチャー 「Star Wars ジェダイ：フォールン・オーダー」で銀河を旅して冒険を繰り広げよう。『スター・ウォーズ エピソード3／シスの復讐』に続く時代、オーダー66による粛清をかろうじて逃れた一人のパダワンを主人公にしたストーリー性の高いシングルプレイヤー・アドベンチャーが幕を開ける。帝国とその恐るべき尋問官たちが迫りくる中、ジェダイ・オーダーの復活を目指すために、引き裂かれた自身の過去を拾い上げ、ジェダイの訓練を完了し、新しい強力なフォース・アビリティを身に着けて、ライトセーバーの技をマスターせよ。
                    </p>
                    ...
                    <img class="col-8 my-3" src="./img/jedi2.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                    ...
                    <img class="col-8 my-3" src="./img/jedi3.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        ジェダイの訓練を活かして敵を打ち破り、探求の旅の先に待ち受ける謎を解き明かそう。
                    </p>
                </div>
            </div>
    </main>
