...
try {
    ...
    $columns = '';
    $columns = $dba->SELECT('t_items', DBA::ALL, DBA::NUMVALUE, 'item_id = ?', [42]);
...
<head>
    ...
    <!-- ここに商品名 -->
    <title>初音ミク Project DIVA Future Tone DX</title>
        ...
        <div class="container-fluid my-5">
            ...
            <div class="container-fluid my-4">
                ...
                <div class="row justify-content-center">
                    ...
                    <img class="col-8 my-3" src="./img/miku1.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        『初音ミク Project DIVA Future Tone DX』は、PS Storeで配信中のリズムゲーム『初音ミク Project DIVA Future Tone』に、さまざまな要素を追加したパッケージ版。<br>
                    ...
                    <img class="col-8 my-3" src="./img/miku2.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        メインとなる「リズムゲーム」モードには、「初音ミク」が誕生してからの10年間を代表するヒット曲・話題曲を多数収録。<br>
                        総収録曲数は238曲と、かつてないボリュームの「Project DIVA」が登場。<br>
                        また、コスチュームは全396着を収録。好きなコスチュームと髪型を組み合わせることができる「髪型カスタマイズ機能」により、キャラクターカスタマイズの楽しさも大きく広がった。
                    </p>
                    ...
                    <img class="col-8 my-3" src="./img/miku3.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        パッケージ版の発売を記念して、動画投稿サイトの再生数が950万回を超えるメガヒット楽曲「ゴーストルール」（Music & Lyrics by DECO*27）を新規収録。<br>
                        新規制作のPVとともに、楽曲をイメージしたコスチュームも追加される。また、歌声合成ソフトウェア「初音ミク」誕生10周年の記念コスチュームも登場。
                    </p>
                </div>
            </div>
    </main>
