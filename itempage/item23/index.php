...
try {
    ...
    $columns = '';
    $columns = $dba->SELECT('t_items', DBA::ALL, DBA::NUMVALUE, 'item_id = ?', [23]);
        ...
        <div class="container-fluid my-5">
            ...
            <div class="container-fluid my-4">
                ...
                <div class="row justify-content-center">
                    ...
                    <img class="col-8 my-3" src="./img/mariocart1.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        透明になれる「テレサ」や、高くジャンプして攻撃をかわせる「ハネ」などのアイテムが新たに追加。また、アイテムを２つまで持てるようになり、戦略性が大幅にアップ
                    </p>
                    ...
                    <img class="col-8 my-3" src="./img/mariocart2.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                    ...
                    <img class="col-8 my-3" src="./img/mariocart3.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
