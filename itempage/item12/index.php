...
try {
    ...
    $columns = '';
    $columns = $dba->SELECT('t_items', DBA::ALL, DBA::NUMVALUE, 'item_id = ?', [12]);
...
<head>
    ...
    <!-- ここに商品名 -->
    <title>METAL GEAR SOLID V: GROUND ZEROES + THE PHANTOM PAIN</title>
        ...
        <div class="container-fluid my-5">
            ...
            <div class="container-fluid my-4">
                ...
                <div class="row justify-content-center">
                    ...
                    <img class="col-8 my-3" src="./img/metal1.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        2010年に発売した『METAL GEAR SOLID PEACE WALKER』から数ヶ月後の1975年。<br>
                        かつてスネークと戦い生死不明となっていた女性工作員「パス」と、彼女を助けるために捕われた少年「チコ」を救うため、キューバ南端の軍事基地に潜入するところから『 METAL GEAR SOLID V』の物語は始まる。
                    </p>
                    ...
                    <img class="col-8 my-3" src="./img/metal2.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        『MGSV:GZ』から9年後、1984年を舞台とした『METAL GEAR SOLID V: THE PHANTOM PAIN』は、「オープンワールドで自由度の高いリアルな潜入」をコンセプトに、時間経過や天候変化の概念のある広大なフィールドで、ミッションをクリアする手段もルートもプレーヤー次第という「自由潜入」を楽しめる。
                    </p>
                    ...
                    <img class="col-8 my-3" src="./img/metal3.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        『MGSV:TPP』本編のシステムを利用して多人数同時オンライン対戦プレーが楽しめる、オンラインマルチモードとして『METAL GEAR ONLINE』（以下、MGO）が収録されている。<br>
                        ジャングルや海上のマザーベースといったさまざまなステージで白熱した対戦を楽しめる。
                    </p>
                    ...
                    <img class="col-8 my-3" src="./img/metal4.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        これまでに配信された武器やアイテム、すべてのダウンロードコンテンツを収録。<br>
                        『MGSV:GZ』、『MGSV:TPP』および『MGO』で使える。
                    </p>
                </div>
            </div>
    </main>
