...
try {
    ...
    $columns = '';
    $columns = $dba->SELECT('t_items', DBA::ALL, DBA::NUMVALUE, 'item_id = ?', [14]);
...
<head>
    ...
    <!-- ここに商品名 -->
    <title>クラッシュ・バンディクー ブッとび3段もり!ボーナスエディション</title>
        ...
        <div class="container-fluid my-5">
            ...
            <div class="container-fluid my-4">
                ...
                <div class="row justify-content-center">
                    ...
                    <img class="col-8 my-3" src="./img/bandhi1.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        『ボーナスエディション』には、好評配信中の高難易度ステージ｢あらしのこじょう｣に加えて、新たなボーナスステージ｢きんみらいステージ｣が追加で収録。
                    </p>
                    ...
                    <img class="col-8 my-3" src="./img/bandhi2.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        約20年の時を越えて新しく作られた新レベル。シリーズ第1作でお蔵入りした、まぼろしの｢滝のレベル｣からインスパイアされたこのステージでは、第3作の「未来ステージ」に出てきたパズルもクリアしなければならない。
                    </p>
                    ...
                    <img class="col-8 my-3" src="./img/bandhi3.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
