...
try {
    ...
    $columns = '';
    $columns = $dba->SELECT('t_items', DBA::ALL, DBA::NUMVALUE, 'item_id = ?', [38]);
        ...
        <div class="container-fluid my-5">
            ...
            <div class="container-fluid my-4">
                ...
                <div class="row justify-content-center">
                    ...
                    <img class="col-8 my-3" src="./img/MHR1.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        解像度設定やフレームレート設定などの画質調整が可能なほか、
                        テクスチャを高解像度化することができ、より精細な表現でゲームを楽しめます。
                    </p>
                    ...
                    <img class="col-8 my-3" src="./img/MHR2.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        「グラフィック詳細設定」を選択すると、より高度な設定変更を行うことができ、
                        自身のゲーム環境に応じた細かな調整による快適なプレイが可能です。
                    </p>
                    ...
                    <img class="col-8 my-3" src="./img/MHR3.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        ゲームパッド操作に加えて、キーボード＆マウスで操作することが可能。<br>
                        キーボード用ショートカットの設定などもカスタマイズすることができます
                    </p>
                </div>
            </div>
    </main>
