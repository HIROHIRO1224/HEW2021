...
try {
    ...
    $columns = '';
    $columns = $dba->SELECT('t_items', DBA::ALL, DBA::NUMVALUE, 'item_id = ?', [35]);
        ...
        <div class="container-fluid my-5">
            ...
            <div class="container-fluid my-4">
                ...
                <div class="row justify-content-center">
                    ...
                    <img class="col-8 my-3" src="./img/Talse.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        「テイルズ オブ アライズ」は“継承と進化”をテーマにして開発を行った、
                        『テイルズ オブ』シリーズ25周年記念タイトルです。<br>

                        「アトモスシェーダー」で描かれる自然世界 - アニメ表現と水彩画の２つに
                        インスピレーションを得た新グラフィックシェーダーが登場。美しく繊細な
                        ビジュアルテイストの背景を、魅力的なデザインのキャラクターたちが旅する。
                    </p>
                    ...
                    <img class="col-8 my-3" src="./img/Talse2.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        昼夜によって表情を変え、個性豊かな自然環境が
                        入り交じるダナの世界をめぐる冒険。岩場を乗り越え、川を泳ぎ、焚き火を囲んで集い、
                        料理を作り、次の街へ向かい、異星の支配者を倒して人々を解放しよう。
                    </p>
                    ...
                    <img class="col-8 my-3" src="./img/Talse3.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        新システム「ブーストストライク」で
                        、パーティの仲間と共に強力な連携攻撃が可能に。術技、ブーストアタック、
                        ブーストストライクのコンボを繋げて敵を倒せ！
                    </p>


                    <h3 class="col-9 mt-5 font-weight-bold mb-3">
                        支配者の星レナと奴隷の星ダナに分かたれた世界の物語体験 -
                    </h3>
                    <img class="col-8 my-3" src="./img/Talse4.jpg" alt="">
                    <p class="col-9" style="line-height:2rem">
                        ２つの星の宿命を決める主人公アルフェンとシオン、さらに様々な個性豊かな仲間が
                        ともに苦難を乗り越えて成長していく。ufotable制作による豪華アニメーションが
                        ドラマの要所に挿入され、彼らの物語を彩ります。
                    </p>
                </div>
            </div>
    </main>
