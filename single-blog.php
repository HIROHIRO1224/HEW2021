	...
	<div class="latest-news-section">
		...
		<div class="news-ticker">
			<div class="news-ticker-contant">
				<div class="nt-item"><span class="new">new</span>サンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプル</div>
				<div class="nt-item"><span class="strategy">strategy</span>サンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプル
				</div>
				<div class="nt-item"><span class="racing">racing</span>サンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプル </div>
			</div>
		</div>
	</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-xl-5 col-lg-6 text-white">
						...
						<p>サンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプル サンプルサンプルサンプルサンプルサンプル</p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-lg-8">
					...
					<div class="blog-content">
						...
						<p>サンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプル サンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプル
							サンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプル サンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプル </p>
						<p>サンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプル サンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプル
							サンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプル サンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプル
							サンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプル </p>
					</div>
					<div class="comment-warp">
						<h4 class="comment-title">最近のコメント</h4>
						<ul class="comment-list">
							<li>
								<div class="comment">
									<div class="comment-avator set-bg" data-setbg="img/authors/1.jpg"></div>
									<div class="comment-content">
										<h5>Jack <span>2022年 5月6日</span></h5>
					...
					<div class="comment-form-warp">
						<h4 class="comment-title">レビュー</h4>
						<form class="comment-form">
							<div class="row">
								...
								<div class="col-lg-12">
									...
									<button class="site-btn btn-sm">送る</button>
								</div>
							</div>
						</form>
					</div>
				...
				<div class="col-lg-4 col-md-7 sidebar pt-5 pt-lg-0">
						...
						<div class="latest-blog">
							<div class="lb-item">
								...
								<div class="lb-content">
									<div class="lb-date">2022年 5月6日</div>
					...
					<!-- widget -->
					<div class="widget-item">
						<h4 class="widget-title">コメント</h4>
						<div class="top-comment">
							<div class="tc-item">
								<div class="tc-thumb set-bg" data-setbg="img/authors/1.jpg"></div>
								<div class="tc-content">
									<p><a href="#">James Smith</a> <span>on</span> サンプルサンプルサンプル</p>
									<div class="tc-date">2022年 5月6日</div>
								</div>
							</div>
							<div class="tc-item">
								<div class="tc-thumb set-bg" data-setbg="img/authors/2.jpg"></div>
								<div class="tc-content">
									<p><a href="#">Michael James</a> <span>on</span>サンプルサンプルサンプル</p>
									<div class="tc-date">2022年 5月6日</div>
								</div>
							</div>
							<div class="tc-item">
								...
								<div class="tc-content">
									<p><a href="#">Justin More</a> <span>on</span> サンプルサンプルサンプル</p>
									<div class="tc-date">2022年 5月6日</div>
								</div>
							</div>
						</div>
					...
					<div class="widget-item">
						<div class="feature-item set-bg" data-setbg="img/features/1.jpg">
							...
							<div class="fi-content text-white">
								<h5><a href="#">Leag Of Legends</a></h5>
								<p>サンプルサンプルサンプルサンプルサンプルサンプル </p>
