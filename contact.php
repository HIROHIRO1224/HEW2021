...
<body>
			...
			<div class="container">
				<div class="row">
					<div class="col-xl-5 col-lg-6 text-white">
						<h2>お問い合わせ</h2>
						<p>サンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプル</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 mb-5 mb-lg-0">
					<h4 class="comment-title">お問い合わせ</h4>
					<p>サンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプル
					</p>
					<div class="row">
						<div class="col-md-9">
							<ul class="contact-info-list">
								<li>
									<div class="cf-left">アドレス</div>
									<div class="cf-right">愛知県名古屋市中村区名駅4丁目27-1</div>
								</li>
								<li>
									<div class="cf-left">電話番号</div>
									<div class="cf-right">+81 070 ???? ????</div>
								</li>
								<li>
									<div class="cf-left">E-mail</div>
									<div class="cf-right">halnagoya@gmail.com</div>
								</li>
							</ul>
						</div>
					</div>
						...
						<form class="comment-form">
							<div class="row">
								...
								<div class="col-lg-12">
									...
									<button class="site-btn btn-sm">送信</button>
								</div>
							</div>
						</form>
					</div>
	...
	<!-- load for map -->
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCWTIlluowDL-X4HbYQt3aDw_oi2JP0Krc&sensor=false">
	</script>
